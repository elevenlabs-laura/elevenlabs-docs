...
<AccordionGroup>
  ...
  Once you've added text, either by importing it or adding it yourself, you can use the Export button to generate audio for the entire chapter or project in one step. It will automatically generate and download an audio file, but you still have the option to edit your project. Once you're done editing, you will need to use the Export button again to generate and download a new version of your project that includes the updated audio.
  </Accordion>

{' '}
<Accordion title="Play">
  If you have not yet generated audio for a paragraph, you can use the Play button to generate audio
  and play it. Generating audio will cost credits. If you have already geneated audio, then the Play
  button will play the already generated audio and you won't be charged any credits.
</Accordion>

{' '}
<Accordion title="Generate/Regenerate">
  The generate button will generate audio if you have not yet generated audio for the selected text,
  or will generate new audio if you have already generated audio. This will cost credits. If you
  have made changes to the paragraph such as changing the text or the voice, then the paragraph will
  lose its converted status, and will need to be generated again. If the button says "Regenerate",
  then this means that you're eligible for a free regeneration. You're eligible for two free
  regenerations provided you don't change the voice or the text.
</Accordion>
  ...
  <Accordion title="Multiselect paragraphs">
  </Accordion>
</AccordionGroup>
