...
<AccordionGroup>
  ...
  If you have not yet generated audio for a paragraph, you can use the Play button to generate audio and play it. Generating audio will cost credits. If you have already geneated audio, then the Play button will play the already generated audio and you won't be charged any credits.
  </Accordion>
  ...
  If the button says "Regenerate", then this means that you're eligible for a free regeneration. You're eligible for two free regenerations provided you don't change the voice or the text. 
  </Accordion>
